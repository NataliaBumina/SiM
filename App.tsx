        ...
        <div className="mx-auto mt-12 max-w-3xl">
          {submitted ? (
            ...
            <form onSubmit={handleSubmit} className="rounded-3xl border border-slate-100 bg-white p-8 shadow-xl shadow-slate-100/50 md:p-12">
              ...
              <button
                type="submit"
                className="group mt-6 flex w-full items-center justify-center gap-2 rounded-2xl bg-gradient-to-r from-orange-500 to-amber-500 px-8 py-4 text-lg font-bold text-white shadow-xl shadow-orange-200 transition-all hover:shadow-2xl hover:shadow-orange-300 hover:-translate-y-0.5"
              >
                <Send size={20} />
                Отправить сообщение
                <ArrowRight size={20} className="transition-transform group-hover:translate-x-1" />
